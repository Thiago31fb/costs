...
const Project = () => {
  ...
  useEffect(() => {
      fetch(`https://json-server-neon-omega.vercel.app/projects/${id}`, {
        method: "GET",
        headers: {
  ...
  function editPost(project) {
    ...
    fetch(`https://json-server-neon-omega.vercel.app/projects/${project.id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function removeService(id, cost) {
    ...
    fetch(
      `https://json-server-neon-omega.vercel.app/projects/${projectUpdate.id}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
